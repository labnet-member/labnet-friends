...
namespace VRC.ToonStandard
{
    ...
    {
        private const string SHADER_NAME = "VRChat/Mobile/Toon Standard";
        private const string SHADER_NAME_OUTLINE = "VRChat/Mobile/Toon Standard (Outline)";
        ...
        public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
        {
            ...
            if(material.shader.name != SHADER_NAME && material.shader.name != SHADER_NAME_OUTLINE)
                EditorGUI.BeginDisabledGroup(true);

            DrawMain(materialEditor, material);
            DrawLighting(materialEditor, material);
            if (material.shader.name == SHADER_NAME_OUTLINE)

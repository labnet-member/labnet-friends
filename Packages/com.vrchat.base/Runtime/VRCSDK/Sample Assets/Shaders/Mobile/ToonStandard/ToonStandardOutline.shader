...
Shader "VRChat/Mobile/Toon Standard (Outline)"
{
    ...
    SubShader
    {
        ...
        {
            Name "FORWARD"
            Tags { "LightMode" = "ForwardBase" "VRCFallback" = "toonstandard" }
            ...
            #pragma shader_feature_local_fragment _ USE_RIMLIGHT
            ...
            #pragma shader_feature_local_fragment _ USE_HUE_SHIFT
